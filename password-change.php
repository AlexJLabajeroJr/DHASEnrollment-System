   ...
   border-radius: 15px 50px;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
    text-align: center;  ">
                            ...
                            <div class="card-header text-center">
                              <a href="index2.html" class="h3" tyle='font-family:Segoe UI'><b>Change Password</b></a>
                            </div>
                            <div class="card-body">
                              ...
                              <form method="POST" action="password-reset-code.php">
                                ...
                                <div class="row">
                                  ...
                                  <!-- /.col -->
                                  <div class="col-12">
                                    <button name="password_update" type="submit" class="btn btn-success btn-block">Change Password</button>
                                  </div>
                                  <!-- /.col -->
                                </div>
