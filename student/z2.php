...
" class="text-light"><?= $row['first_name'] ?> <?= $row['last_name'] ?></p>
            </div>
                        ...
                        <div>
                           ...
                           <div class="card-body border border-1">
                              ...
                              <div class="card-body">
                                 ...
                                 <section id="multiple-column-form border border-1" style="  border-radius: 10px 10px 10px  10px ; overflow: hidden">
                                                      ...
                                                      <div class="row">
                                                         ...
                                                         <div class="col-sm-6 text-left">
                                                            <div>
                                                               ...
                                                               <input value="Academic Year:<?= $searchYrRow['school_year']; ?> " style="font-size:30px; font-family:Segoe Script;" class="form-control input-sm  border border-0 text-left">

                                                               <?php if ($row['GRADE_LEVEL_ID'] == '23' || $row['GRADE_LEVEL_ID'] == '24') { ?>
                                                                  <input value=" <?= $searchSetResultRow['SEMESTER']; ?> Semester" style="font-size:20px; font-family:Segoe Script; margin-left:2px;" class=" form-control input-sm  border border-0 text-left" style="font-size:20px;">
                                                               <?php } ?>
                                                         ...
                                                         <div class="col-sm-5 text-center">
                                                            <div>
                                                               <p class=" text-center  text-dark mb-2" style=" font-family:Segoe UI; font-size:30px; color:white;">PRE-REGISTRATION FORM</p>
                                                               <hr>
                                                            ...
                                                            <div class="col-sm-4">
                                                               ...
                                                               <div class="container-fluid">
                                                                  <div class="row">
                                                                     ...
                                                                     <div class="col-sm-8">
                                                                        <h5 class=" text-left  text-dark" style=" font-family:Segoe UI;  font-size:12px;color:white;">PRE-REGISTRATION STATUS</h5>
...
font-family:Segoe UI; font-size:10px;
  ...
  border-width: 1px;  border-color:	#ffffff;"><?= $row['status']; ?>
                                                                              ...
                                                                              if ($Delly) {
                                                                              ?>
                                                                                 <span id="success" class="badge badge-xs bg-danger" style="
font-family:Segoe UI; font-size:10px;
    overflow: hidden;   box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 4px 20px 0 rgba(0, 0, 0, 0.19); 
    border-style:solid;
  border-width: 1px;  border-color:	#ffffff;"><?= $row['status']; ?>
                                                            ...
                                                            <div class="col-sm-4">
                                                               ...
                                                               <div class="container-fluid">
                                                                  <div class="row">
                                                                     ...
                                                                     if ($statko) {
                                                                     ?>
                                                                        <button type="button" class="btn btn-default btn-xs toastsDefaultDefault">

                                                                           <i class="fas fa-bullhorn"></i> Click this !
                                                                        </button>
                                                                     <?php } ?>
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-7">
                                                               ...
                                                               <div class="container">
                                                                  <div class="row">
                                                                     <div class="col-sm-3">
                                                                        <h5 class=" text-left  text-dark" style=" font-family:Segoe UI;  font-size:12px;color:white;">STUDENT TYPE</h5>
...
font-family:Segoe UI; font-size:10px; 
    overflow: hidden;   box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 4px 20px 0 rgba(0, 0, 0, 0.19); 
    border-style:solid;
  border-width: 1px;  border-color:	#ffffff;">&nbsp <?= $row['student_type']; ?> &nbsp</span>
                                                                        <?php } ?>
                                                                     </div>
                                                                  </div>
                                                               </div>
  ...
  border-width: 3px;  border-color:	#ffffff;" -->
                                                      ...
                                                      <br>
                                                      <br>
                                                      &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<img src="../img/clip-45.png" style="width:90px;height:250px; margin-top:10px" />
                                                      <!-- <img src="../img/clip-46.png" style="width:200px;height:250px;" /> -->
                                                      <img src="../img/clip-133.png" style="width:80px;height:70px; " />
                                                   ...
                                                   <div class="col-lg-4 col-md-12 ">
                                                      ...
                                                      <form id="regiration_form" method="post" enctype="multipart/form-data">
                                                         <fieldset>
                                                            ...
                                                            <p class=" text-left  text-dark mb-2" style=" font-family:Segoe UI; color:white;">PERSONAL INFORMATION</h3>
                                                            ...
                                                            <div class="form-group row">
                                                               <label class="col-sm-4 col-form-label" style=" font-family:Segoe UI; color:#121;">Upload Image <B style="color:red">*</B></label>
                                                            ...
                                                            <input type="button" name="birthplace" class="next btn btn-1 bg-indigo" value="Next" />
                                                         ...
                                                         <fieldset>
                                                            ...
                                                            <input type="button" name="next" class="next btn btn-1 bg-purple" value="Next" />
                                                         ...
                                                         <fieldset>
                                                            ...
                                                            <p class=" text-left  text-dark mb-2" style=" font-family:Segoe UI; color:white;">ADDRESS INFORMATION</h3>
                                                               <i class='fa-solid fa-location-dot red-color'></i>
                                                               <br>
                                                               <br>
                                                         ...
                                                         <fieldset>
                                                            ...
                                                            <p class=" text-left  text-dark mb-2" style=" font-family:Segoe UI; color:white;">PARENT / GUARDIAN INFORMATION</h3>
                                                         ...
                                                         <fieldset>
                                                            ...
                                                            <p class=" text-left  text-dark mb-2" style=" font-family:Segoe UI; color:white;">OTHER INFORMATION</h3>
