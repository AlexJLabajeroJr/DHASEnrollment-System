                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="number" placeholder="Ex.13" name="age" class="form-control form-control-sm" value="<?= $row['age'] ?>" maxlength="2" <?php if ($row['age'] != '') {
                                                                                                                                                                                                        echo "disabled ";
                                                                                                                                                                                                    } ?> required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" oninvalid="alert('Please enter your Age.')">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="number" name="contact_number" placeholder="Ex.09021013245" class="form-control form-control-sm" value="<?= $row['contact_number'] ?>" <?php if ($row['contact_number'] != '') {
                                                                                                                                                                                                                        echo "disabled ";
                                                                                                                                                                                                                    } ?>required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="11" oninvalid="alert('Please enter your Contact number.')">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="number" placeholder="Ex.4700" name="zip_code" class="form-control  " value="<?= $row['zip_code'] ?>" <?php
                                                                                                                                                                                    ...
                                                                                                                                                                                    ?>required oninvalid="alert('Please enter your Zip_code.')">
                                                            </div>
                                                        </div>
                                                ...
                                                <section>
                                                    <div class="form-wrap max-width-1000 mx-auto">
                                                        ...
                                                        <?php if ($row1['student_id'] == '0') : ?>
                                                            <button type="submit" id="success-modal-btn" hidden data-toggle="modal" data-target="#success-modal" data-backdrop="static" name="<?= $action ?>" value="<?= $btn_value ?>">Launch modal</button>
                                                        <?php else : ?>
