...
<div class="wrapper">
                                    ...
                                    <div class=" container">
                                        <div class="row">
                                            ...
                                            <div class="col-6 mt-5 mb-5">
                                                <div class="login-box">
                                                    <div class="card card-outline card-purple" class=" border border-10 text-light " style="   background:;  padding: 15px;
  ...
  border-width: 5px;  ">
                                                        ...
                                                        <div class="card-header text-center">
                                                            <a href="resend-email-verification.php" class="h3" style='font-family:Segoe UI'><b>Resend your Email</b></a>
                                                        </div>
                                                        <div class="card-body">
                                                            ...
                                                            <form method="POST" action="resend_code.php">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="text" name="email" class="form-control" id="name" pattern="[^ @]*@[^ @]*" placeholder="Email">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <!-- /.col -->
                                                                    <div class="col-12">
                                                                        <button name="resend_email_verify_btn" type="submit" class="btn btn-success btn-block">Resend Password</button>
                                                                    </div>
                                                                    <!-- /.col -->
                                                                </div>
