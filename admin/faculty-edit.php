                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">EDIT FACULTY <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                                        </div>
                                        <div class="col-sm-2">
                                            <a href="faculty.php" class="btn btn-warning float-end">BACK</a>
                                        </div>
                                    </div>
                                </div>
                                </h3>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            ?>
                                                    ...
                                                    <!-- <form action="../queries/updateImage.php?student_id=<?php echo $searchIMResultRow['student_id']; ?>" method="POST"> -->
                                                    ...
                                                    <form action="faculty_code.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            <label>Faculty Fullname</label>
                                                            <input type="text" name="fac_name" value="<?= $faculty['fac_name']; ?>" class="form-control">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label>Faculty Contact</label>
                                                            <input type="number" name="fac_contact" value="<?= $faculty['fac_contact']; ?>" class="form-control">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label>Faculty Email</label>
                                                            <input type="email" name="email" value="<?= $faculty['email']; ?>" class="form-control">
                                                        </div>

                                                        <div class="mb-3">
                                                            <button type="submit" name="update_faculty" class="btn btn-success">
                                                                Update
                                                            </button>
                                                        </div>
