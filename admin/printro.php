            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class='col-sm-4 text-center '>
                        ...
                        <h6 class="pull-right" style="text-transform: uppercase;">LIST OF ROOMS</h6>
                ...
                <div class="col-sm-12 col-md-12 table-responsive">
                    <table class="table table-bordered table-striped" style="font-size:11px" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            WHERE room_id  LIKE '%" . $_POST['room_id'] . "%'";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    if ($row['availability'] == 0) {
                                        echo "<B class='badge badge-1 text-light border border-1 bg-dark' style='background-color: #; border-radius: 15px 15px 15px 15px; overflow: hidden; border-style: solid; border-width: 3px; border-color: #ffffff;'>Unvailable</B>";
                                    }

                                    if ($row['availability'] == 1) {
                                        echo "<B class='badge badge-1 bg-warning text-light border border-1' style='background-color: #; border-radius: 15px 15px 15px 15px; overflow: hidden; border-style: solid; border-width: 3px; border-color: #ffffff;'>Available</B>";
                                    }
                                ...
                                echo '<tr><td colspan="12">No room found</td></tr>';
                            }
