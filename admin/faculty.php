               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="faculty.php" class="nav-link active bg-light">
                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">MANAGE FACULTY <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                                        </div>

                                        <div class="col-sm-2">

                                            <a href="faculty-create.php" class="btn btn-success float-end text-light" class="btn btn-success btn-sm" style="
                                ...
                                <div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <tbody class="text-center">
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><img src="<?= $faculty['p_p']; ?>" style="width: 40px; height: 40px; opacity: 0.8;"></td>

                                                                <td><?= $faculty['fac_name']; ?></td>
                                                                <td><?= $faculty['fac_contact']; ?></td>
                                                                <td><?= $faculty['email']; ?></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu text-center" role="menu">
                                                                            ...
                                                                            <a class="dropdown-item" href="#"> <a href="faculty-view.php?faculty_id=<?= $faculty['faculty_id']; ?>" class="btn btn-primary btn-sm border border-1" href="#">
                                                                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fas fa-folder">
                                                                                    </i>
                                                                                    View&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                                                </a> </a>


                                                                            <a class="dropdown-item" href="#"> <a href="faculty-edit.php?faculty_id=<?= $faculty['faculty_id']; ?>" class="btn btn-info btn-sm border border-1" href="#">
                                                                            ...
                                                                            <a class="dropdown-item text-light" href="#">
                                                                                <form action="faculty_code.php" method="POST" class="d-inline">
                                                                                    <button type="submit" name="delete_faculty" value="<?= $faculty['faculty_id']; ?>" class="btn btn-danger btn-sm mt-1 border border-1">
                                                                                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fas fa-trash"></i> Delete&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                                                    </button>
                                                                                </form>
                                                                            </a>
                                            ...
                                            <form action="printfac.php" method="POST" target="_blank">
