               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item  ">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="school_year.php" class="nav-link  text-light">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Set School_year</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="setsem.php" class="nav-link active bg-light">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Set Semester</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">SET-SEMESTER<b class="text-danger" style="font-family:Segoe UI;"><i></b><b></b></i></b></h3>
                                        </div>
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                if ($result) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        if ($SETSEM == 1) {
                                                            echo "   <span id='success' class='badge bg-success'>Active</span>
                                                            ";
                                                        } else if ($SETSEM == 0) {
                                                            echo "   <span id='success' class='badge bg-danger'>Inactive</span>
                                                            ";
                                                        }
                                                        echo "</td>";

                                                        echo "<td><a href = 'set.php?SEMID=$row[SEMID]&SETSEM=$row[SEMID]'  class='btn btn-primary btn-lg' >SET</a></td>";
                                                    }
                                                }
