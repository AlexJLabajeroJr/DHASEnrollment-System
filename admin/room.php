...
if (isset($_GET['room_id']) && isset($_GET['availability'])) {
   $room_id = $_GET['room_id'];
   $availability = $_GET['availability'];
   mysqli_query($conn, "update room set availability ='$availability' where room_id='$room_id'");
   header("location:room.php?upt=1");
   die();
}
...
font-family:Segoe Script;" class="text-dark text-bold"><b> Hello! <?= $row['name'] ?></b></p>
 ...
 -->
                        ...
                        <!-- <a class="dropdown-item" href="#"> <a href="room-edit.php?room_id=<= $room['room_id']; ?>" class="btn btn-info border border-1 btn-sm text-uppercase" href="#">
                        ...
                        <a class="dropdown-item">
                           <form action="room_code.php" method="POST" class="d-inline">
                              <button type="submit" name="delete_room" value="<= $room['room_id']; ?>" class="btn btn-danger btn-sm text-uppercase" href="#">
                        ...
                        <div class="container mt-3">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">MANAGE ROOM <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                              </div>

                              <div class="col-sm-2">

                                 <a href="room-create.php" class="btn btn-success float-end text-light" class="btn btn-success btn-sm" style="
font-family:Segoe UI; font-size:15px; border-radius: 15px 15px 15px 15px;
   "> <i class="fa fa-plus" aria-hidden="true"></i>Add Room</a>
                                 </button>
                              </div>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   ...
                                                   if ($room['availability'] == '0') {
                                                      echo " <div class='badge badge-1 bg-yellow'>
   <span class='fa fa-circle-info bg-light '></span> UNAVAILABLE
</div>";
                                                   }
                                                   if ($room['availability'] == '1') {
                                                      echo " <div class='badge badge-1 bg-green'>
   <span class='fa fa-circle-info bg-light '></span> AVAILABLE
</div>";
                                                   }
                                                   ?>
                                                ...
                                                <td>
                                                   <select class="form-control badge badge-xs" onchange="status_update(this.options[this.selectedIndex].value,'<?php echo $room['room_id'] ?>')">
                                                ...
                                                <td>
                                                   ...
                                                   <div class="btn-group">
                                                      ...
                                                      <div class="dropdown-menu text-center" role="menu">
                                                         ...
                                                         <a class="dropdown-item" href="#"> <a href="room-edit.php?room_id=<?= $room['room_id']; ?>" class="btn btn-info btn-sm border border-dark" href="#">
                                                               &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fas fa-pencil-alt">
                                                               </i>
                                                               Edit&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                            </a></a>


                                                         <a class="dropdown-item" href="#">
                                                            <form action="room_code.php" method="POST" class="d-inline">
                                                               <button type="submit" name="delete_room" value="<?= $room['room_id']; ?>" class="btn btn-danger btn-sm border border-dark" href="#">
                                                                  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fas fa-trash">
                                                                  </i>
                                                                  Delete&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp </button>
                                                            </form>
                                                         </a>
                                 ...
                                 <form action="printro.php" method="POST" target="_blank">
                                    <input type="hidden" name="room_id" value="<?php echo (isset($_POST['room_id'])) ? $_POST['room_id'] : ''; ?>">
...
<script type="text/javascript">
   function status_update(value, room_id) {
      //alert(id);  
      let url = "http://localhost/Enrollment/admin/room.php";
      window.location.href = url + "?room_id=" + room_id + "&availability=" + value;
   }
</script>
