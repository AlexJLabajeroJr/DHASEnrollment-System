                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <p class="bg-light text-center text-light" style="font-family: Segoe UI; color: white;">
                                                &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp TOTAL NUMBER OF ENROLLED STUDENTS &nbsp =
                ...
                AND sch.enrollment_status = '2' AND  sch.requirement_status = '1' AND  sch.payment_status = '1' AND sch.archieve = '0'   ";
                                    ...
                                    <table id="example1" class="table table-bordered table-striped" style="font-size:12px" cellspacing="0">
                                        <thead class="text-center bg-light">
                                            ...
                                            <th class="text-left">Date Enrolled</th>
                                        ...
                                        <tbody class="text-center">
                                            ...
                                            if ($count >= $max_students) {
                                                ...
                                                $query = "SELECT * FROM schoolyr as sch INNER JOIN student as stud ON sch.student_id = stud.student_id INNER JOIN grade_level as grad ON stud.GRADE_LEVEL_ID = grad.GRADE_LEVEL_ID WHERE stud.GRADE_LEVEL_ID = '11' && stud.status = 'Approved'  && sch.enrollment_status = '2' && sch.archieve = '0' ORDER BY stud.student_id ASC";
                                                    ...
                                                    if ($count >= $max_students) {
                                                        if ($row->student_type == 'new' || $row->student_type == 'transferee' || $row->student_type == 'returnee') {
                                                            echo '<td align="center">
                                                                ...
                                                                <a title="View" href="controller2.php?action=view&student_id=' . $row->student_id . '" class="btn btn-1 btn-sm border border-1 mb-2" style="background-color:#fff">
