                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Edit Grade_level</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">EDIT GRADE LEVEL <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                                        </div>
                                        <div class="col-sm-2">
                                            <a href="grade_level.php" class="btn btn-danger float-end">BACK</a>
                                        </div>
                                    </div>
                                </div>
                                </h3>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            if (isset($_GET['GRADE_LEVEL_ID'])) {
                                                $GRADE_LEVEL_ID = mysqli_real_escape_string($conn, $_GET['GRADE_LEVEL_ID']);
                                                $query = "SELECT * FROM grade_level WHERE GRADE_LEVEL_ID='$GRADE_LEVEL_ID' ";
                                                $query_run = mysqli_query($conn, $query);

                                                if (mysqli_num_rows($query_run) > 0) {
                                                    $grade_level = mysqli_fetch_array($query_run);
                                            ?>



                                                    <form action="grade_level_code.php" method="POST">
                                                        <input type="hidden" name="GRADE_LEVEL_ID" value="<?= $grade_level['GRADE_LEVEL_ID']; ?>">

                                                        <div class="mb-3">
                                                            <label>Grade_level</label>
                                                            <input type="number" name="GRADE_LEVEL" value="<?= $grade_level['GRADE_LEVEL']; ?>" class="form-control ">
                                                        </div>

                                                        <div class="mb-3">
                                                            <label>Strand_Name</label>
                                                            <input type="text" name="GRADE_NAME" value="<?= $grade_level['GRADE_NAME']; ?>" class="form-control ">
                                                        </div>

                                                        <div class="mb-3">
                                                            <label>Description</label>
                                                            <input type="text" name="GRADE_DESC" value="<?= $grade_level['GRADE_DESC']; ?>" class="form-control ">
                                                        </div>



                                                        <div class="mb-3">
                                                            <button type="submit" name="update_grade_level" class="btn btn-primary">
                                                                Update
                                                            </button>
                                                        </div>
