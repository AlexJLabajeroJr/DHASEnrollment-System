...
$sqlf = "SELECT count(*) as 'enrolleex' FROM schoolyr as sch INNER JOIN student as stud ON sch.student_id = stud.student_id INNER JOIN grade_level as grad ON stud.GRADE_LEVEL_ID = grad.GRADE_LEVEL_ID WHERE stud.GRADE_LEVEL_ID = '19' && sch.enrollment_status = '2' && sch.archieve = '0'";
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody class="text-center">
                                            ...
                                            if ($count >= $max_students) {
                                                ...
                                                $query = "SELECT * FROM schoolyr as sch INNER JOIN student as stud ON sch.student_id = stud.student_id INNER JOIN grade_level as grad ON stud.GRADE_LEVEL_ID = grad.GRADE_LEVEL_ID WHERE stud.GRADE_LEVEL_ID = '19' && stud.status = 'Approved'  && sch.enrollment_status = '2' && sch.archieve = '0' ORDER BY stud.student_id ASC";
