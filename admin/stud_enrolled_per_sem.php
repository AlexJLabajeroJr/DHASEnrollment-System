               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="stud_enrolled_per_sem.php" class="nav-link active">
                    ...
                    <div class="col-sm-12">
                      ...
                      <small class="pull-right">Date: <php echo date('m/d/Y'); ?></small> -->
                                        ...
                                        <div class="form-group">
                                            <select name="grade_level" class="form-control" required>
                                                ...
                                                foreach ($array as $resulta) {
                                                    $selected = ($resulta->GRADE_LEVEL_ID == $selected_grade_level) ? 'selected' : '';

                                                    echo '<option value="' . $resulta->GRADE_LEVEL_ID . '" ' . $selected . '>' . $resulta->GRADE_LEVEL . ' ' . $resulta->GRADE_DESC . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <h2 class="page-header">
                                        <i class="fa fa-globe"></i>List Of Students Enrolled per Semester
                                        <!-- <small class="pull-right"> <?php echo (isset($_POST['grade_level'])) ? 'Grade level ID  :' . $_POST['grade_level'] : ''; ?>
                                    ...
                                    <table class="table table-bordered table-striped" style="font-size:11px" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['submit'])) {
                                                ...
                                                if ($_POST['grade_level'] == 'All') {
                                                    // Get the selected grade level
                                                    // $grade_level_id = $_POST['grade_level'];
                                                    // $Semester = $_POST['Semester'];
                                                    // Retrieve the students based on the selected grade level

                                                    // $que = "SELECT * FROM school_year ";
                                                    // $resulter = mysqli_query($conn, $que);
                                                    // $rowz = mysqli_fetch_assoc($resulter);
                                                    // $school_year_id = $row34['school_year_id'];

                                                    // // // Use the SYID variable in your query
                                                    // $quet = "SELECT school_year_status FROM school_year WHERE school_year_id = $school_year_id AND school_year_status = 1 || school_year_status = 1 ";
                                                    // $resultero = mysqli_query($conn, $quet);
                                                    // $rowz = mysqli_fetch_assoc($resultero);
                                                    // $school_year_id = $row34['school_year_id'];
                                                    ...
                                                    INNER JOIN school_year s ON sy.school_year_id = s.school_year_id
                                                    INNER JOIN student g ON sy.student_id = g.student_id  
                                                    INNER JOIN grade_level gr ON g.GRADE_LEVEL_ID = gr.GRADE_LEVEL_ID 
                                                    WHERE sy.enrollment_status = '2'";
                                            ...
                                            ?>
                                                ...
                                                $grade_level = isset($_POST['grade_level']) ? mysqli_real_escape_string($conn, $_POST['grade_level']) : '';
                                                $COURSE_ID = isset($_POST['Semester']) ? mysqli_real_escape_string($conn, $_POST['Semester']) : '';

                                                $query = "SELECT * FROM schoolyr sy
          INNER JOIN school_year s ON sy.school_year_id = s.school_year_id
          INNER JOIN student g ON sy.student_id = g.student_id  
          INNER JOIN grade_level gr ON g.GRADE_LEVEL_ID = gr.GRADE_LEVEL_ID 
          WHERE CONCAT(GRADE_LEVEL,'-',GRADE_DESC) LIKE '$COURSE_ID' AND school_year_status LIKE '$grade_level'";
