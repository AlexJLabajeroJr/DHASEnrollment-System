                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">ADD SUBJECT <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                                        </div>
                                        <div class="col-sm-2">
                                            <a href="subject.php" class="btn btn-warning float-end">BACK</a>
                                        </div>
                                    </div>
                                </div>
                                </h3>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="subject_code.php" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="subject_description" id="subject_description" class="form-control" required>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    echo "<label>Grade_level</label>";
                                                    echo "<select name='GRADE_LEVEL_ID'   id='GRADE_LEVEL_ID'  class='form-control'> ";
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control input-sm" name="SEMESTER" id="SEMESTER" required>
                                                ...
                                                <div class="mb-3">
                                                    <button type="submit" name="save_subject" class="btn btn-success">Save</button>
                                                </div>
