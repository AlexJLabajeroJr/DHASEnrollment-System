                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add Grade_level</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">ADD GRADE LEVEL <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                                        </div>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="grade_level_code.php" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="GRADE_LEVEL" id="GRADE_LEVEL" class="form-control " placeholder="Ex.1" required>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="GRADE_NAME" id="GRADE_NAME" class="form-control " placeholder="Ex.GAS">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="GRADE_DESC" id="GRADE_DESC" class="form-control " placeholder="General Academic Strand ">
                                                </div>


                                                <div class="mb-3">
                                                    <button type="submit" name="save_grade_level" class="btn btn-primary">Save</button>
                                                </div>
