                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">EDIT SUBJECT <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                                        </div>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            ?>
                                                    ...
                                                    <form action="subject_code.php" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            <label>Subject_code</label>
                                                            <input type="text" name="subject_description" value="<?= $subject['subject_description']; ?>" class="form-control ">
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="GRADE_LEVEL_ID" value="<?= $subject['GRADE_LEVEL_ID']; ?>" class='form-control'>";
                                                                <?php
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control input-sm" name="SEMESTER" value="<?= $subject['SEMESTER']; ?>">
