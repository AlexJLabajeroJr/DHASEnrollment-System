                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">EDIT ROOM <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                                        </div>
                                        <div class="col-sm-2">
                                            ...
                                            ?>
                                                    ...
                                                    <form action="room_code.php" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="building_name" value="<?= $room['building_name']; ?>" class="form-control ">
                                                        </div>
