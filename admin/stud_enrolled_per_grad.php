               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="stud_enrolled_per_grad.php" class="nav-link active">
        ...
        <section class="content">
            ...
            <small class="pull-right">Date: <php echo date('m/d/Y'); ?></small> -->
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <h2 class="page-header">
                                        <i class="fa fa-globe"></i>List Of Students Enrolled per Grade Level
                        ...
                        <form action="printgrade_level.php" method="POST" target="_blank">
