               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="stud_class_sched_p_grad.php" class="nav-link active">
        ...
        <section class="content">
            ...
            <small class="pull-right">Date: <php echo date('m/d/Y'); ?></small> -->
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h2 class="page-header">
                                        <i class="fa fa-globe"></i>List Of Class Schedule per Grade Level
                                            ...
                                            if (isset($_POST['submit'])) {
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo '<td>' . $row['sched_semester'] . '</td>';
                                                        echo '<td>' . $row['sched_sy'] . '</td>';
                                                    }
                        ...
                        <form action="printsched.php" method="POST" target="_blank">
                            <input type="hidden" name="grade_level" value="<?php echo (isset($_POST['grade_level'])) ? $_POST['grade_level'] : ''; ?>">
                            <!-- this row will not appear when printing -->
                            <div class="row no-print">
                                <div class="col-xs-12">
                                    <span class="pull-right"> <button type="submit" class="btn btn-primary"><i class="fa fa-print"></i>&nbsp&nbspPrint&nbsp&nbsp</button></span>
                                </div>
                            </div>
                        </form>
