                     ...
                     <div>
                        ...
                        <div class="container mt-3">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">MANAGE SUBJECT <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                              </div>

                              <div class="col-sm-2">

                                 <a href="subject-create.php" class="btn btn-success float-end text-light" class="btn btn-success btn-sm" style="
font-family:Segoe UI; font-size:15px; border-radius: 15px 15px 15px 15px;
   "> <i class="fa fa-plus" aria-hidden="true"></i>Add Subject</a>
                                 </button>
                              </div>
                              ...
                              <div class="card-body">
                                 <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody class="text-center">
                                       <?php
                                       $query = "Select * from `subject` s, `grade_level` c WHERE s.GRADE_LEVEL_ID=c.GRADE_LEVEL_ID";
                                       ...
                                       ?>
                                             <tr>
                                                ...
                                                <td>
                                                   <!-- <a href="subject-view.php?=<?= $subject['subject_id']; ?>" class="btn btn-info btn-sm">View</a> -->
                                                   ...
                                                   <div class="btn-group">
                                                      ...
                                                      <div class="dropdown-menu text-center" role="menu">
                                                         ...
                                                         <a class="dropdown-item" href="#"> <a href="subject-edit.php?subject_id=<?= $subject['subject_id']; ?>" class="btn btn-info btn-sm border border-dark" href="#">
                                                         ...
                                                         <a class="dropdown-item text-light" href="#">
                                                            <form action="subject_code.php" method="POST" class="d-inline">
                                                               <button type="submit" name="delete_subject" value="<?= $subject['subject_id']; ?>" class="btn btn-danger btn-sm border border-dark" href="#">
                                 ...
                                 <form action="printsub.php" method="POST" target="_blank">
                                    <input type="hidden" name="subject_id" value="<?php echo (isset($_POST['subject_id'])) ? $_POST['subject_id'] : ''; ?>">
