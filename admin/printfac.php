            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class='col-sm-4 text-center '>
                        ...
                        <h6 class="pull-right" style="text-transform: uppercase;">LIST OF FACULTY</h6>
                ...
                <div class="col-sm-12 col-md-12 table-responsive">
                    <table class="table table-bordered table-striped " style="font-size:10px" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            WHERE faculty_id  LIKE '%" . $_POST['faculty_id'] . "%'";
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4" align="right">
                                    <h6>Total Number of faculty/s :</h6>
                                </td>
                                <td>
