...
// $sql = "SELECT count(*) as 'enrollees' FROM student WHERE student_id = 'student_id' && status = 'Pending'";
...
if (isset($_GET['student_id']) && isset($_GET['status'])) {
    ...
    $status = $_GET['status'];
    mysqli_query($conn, "update student set status ='$status' where student_id='$student_id'");
                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">PRE-REGISTRATION STATUS<b class="text-lightblue" style="font-family:Segoe UI;"><i></b><b></b></i></b></h3>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead class="text-center text-1" style="bacKground-color:#;">
                                                <tr>
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                $query = "SELECT * FROM  student as s INNER JOIN grade_level as grad ON s.GRADE_LEVEL_ID = grad.GRADE_LEVEL_ID where status = 'Approved' || status = 'Decline' ";
                                                ...
                                                while ($row = mysqli_fetch_array($result)) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="<?php echo $row['p_p']; ?>" style=" width:40px; height:40px; opacity: .8"> </td>


                                                        <td class=" text-uppercase"><?php echo $row['first_name']; ?> <?php echo $row['suffix_name']; ?>, <?php echo $row['middle_name']; ?>. <?php echo $row['last_name']; ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($row['status'] == 'Decline') {
                                                                ...
                                                                <span class='fa fa-info-circle  '></span> DECLINED
                                                            </div>";
                                                            }
                                                            if ($row['status'] == 'Approved') {
                                                                echo " <div class='badge badge-1 bg-purple'>
                                                                <span class='fa fa-check '></span> APPROVED 
                                                                </div>";
                                                                // echo " <div class='badge badge-1 bg-green'>
                                                                // <span class='fa fa-check '></span> Pending Enrollment
                                                                // </div>";
                                                            }
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($row['status'] == 'Decline') {
                                                            ?>
                                                                <select class="form-control badge badge-xs" onchange="status_update(this.options[this.selectedIndex].value,'<?php echo $row['student_id'] ?>')">
