                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">ADD FACULTY <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                                        </div>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="faculty_code.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    <label>Upload Image <B style="color:red">*</B></label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="fac_contact" maxlength="11" class="form-control" required>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <button type="submit" name="save_faculty" class="btn btn-success">Save</button>
                                                </div>
