               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="grade_level.php" class="nav-link active bg-light">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="grade_level.php">Home</a></li>
                            <li class="breadcrumb-item active">Grade_level</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <div>
                                ...
                                <div class="container mt-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <h3 class="bg-light  text-center  text-light" style="  font-family:Segoe UI; color:white;">MANAGE GRADE LEVEL / STRAND <b class="text-lightblue" style="font-family:Segoe UI;"></b></h3>
                                        </div>

                                        <div class="col-sm-2">

                                            <a href="grade_level-create.php" class="btn btn-success float-end text-light" class="btn btn-success btn-sm" style="
                                        ...
                                        <div class="card-body">
                                            <table id="example1" class="table table-bordered table-striped">
                                                <thead class="text-center">
                                                    <tr>
                                                        <th>&nbspGrade_level_id&nbsp</th>
                                                        <th>&nbspGrade_level&nbsp</th>
                                                        <th>&nbspSection&nbsp</th>
                                                        <th>&nbspStrand_Name&nbsp</th>

                                                        <th>&nbspDescrption&nbsp</th>
                                                ...
                                                <tbody class="text-center">
                                                    ...
                                                    if (mysqli_num_rows($query_run) > 0) {
                                                        foreach ($query_run as $grade_level) {
                                                    ?>
                                                            <tr>
                                                                <td><?= $grade_level['GRADE_LEVEL_ID']; ?></td>

                                                                <td><?= $grade_level['GRADE_LEVEL']; ?></td>
                                                                <td><?= $grade_level['Section']; ?></td>
                                                                <td><?= $grade_level['GRADE_NAME']; ?></td>

                                                                <td><?= $grade_level['GRADE_DESC']; ?></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu text-center" role="menu">
                                                                            ...
                                                                            <a class="dropdown-item" href="#"> <a href="grade_level-edit.php?GRADE_LEVEL_ID=<?= $grade_level['GRADE_LEVEL_ID']; ?>" class="btn btn-info btn-sm border border-dark" href="#">
                                                                            ...
                                                                            <a class="dropdown-item" href="#">
                                                                                <form action="grade_level_code.php" method="POST" class="d-inline">
                                                                                    <button type="submit" name="delete_grade_Level" value="<?= $grade_level['GRADE_LEVEL_ID']; ?>" class="btn btn-danger btn-sm border border-dark" href="#">
