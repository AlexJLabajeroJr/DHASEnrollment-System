               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="stud_enr_per_sub.php" class="nav-link active">
        ...
        <section class="content">
            ...
            <small class="pull-right">Date: <php echo date('m/d/Y'); ?></small> -->
                                ...
                                <div class="col-sm-4 invoice-col">
                                    ...
                                    <address>
                                        <div class="form-group">
                                            <select name="subject" class="wew form-control" required>
                                                <?php
                                                ...
                                                foreach ($array as $resulta) {
                                                    $selected = ($resulta->subject_id == $subject) ? 'selected' : '';

                                                    echo '<option value="' . $resulta->subject_id . '" ' . $selected . '>' . $resulta->subject_code . ' ' . $resulta->subject_description . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <h2 class="page-header">
                                        <i class="fa fa-globe"></i>List Of Students Enrolled per Subjects
                                    ...
                                    <table class="table table-bordered table-striped" style="font-size:11px" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['submit'])) {
                                                ...
                                                INNER JOIN grade_level gr ON s.GRADE_LEVEL_ID = gr.GRADE_LEVEL_ID 
                                                INNER JOIN enrollment e ON s.student_id = e.student_id
                                                WHERE sy.enrollment_status = 2 AND subject_id = $subject";
