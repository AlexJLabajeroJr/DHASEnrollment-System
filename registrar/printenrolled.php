...
<body onload="window.print();">
    <div class="wrapper">
        ...
        <section class="invoice">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h5 class="page-header ">
                        &nbsp &nbsp &nbsp &nbsp<i class="fa fa-globe"></i>Divine Healer Academy of Sorsogon.
            ...
            <div class="row">
                &nbsp &nbsp &nbsp &nbsp<h5 align="center">&nbsp&nbspList Of Enrolled Students </h5>
                ...
                <div class="col-sm-12 col-md-12 table-responsive">
                    <table class="table table-bordered table-striped" style="font-size:11px" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            WHERE sy.enrollment_status = 2 AND sy.SYID  LIKE '%" . $_POST['SYID'] . "%'";
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9" align="right">
                                    <h6>Total Number of Student/s :</h6>
                                </td>
                                <td>
