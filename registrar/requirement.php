               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item menu-open ">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="requirement.php" class="nav-link  active bg-light">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            if (isset($_POST['add_user'])) {
                                ...
                                $checkSKOysject = "SELECT * FROM `requirement` WHERE `requirement` = ?";
                                $stmt = $conn->prepare($checkSKOysject);
                                $stmt->bind_param("s", $requirement);
                                $stmt->execute();
                            ...
                            ?>
                                    ...
                                    $query = "INSERT INTO requirement (requirement) VALUES (?)";
                            ...
                            if (isset($_GET['requirement_id'])) {
                                if (isset($_GET['edit'])) {
                                    $query = "Select * from requirement where requirement_id = " . $_GET['requirement_id'];
                                ...
                                if (isset($_GET['delete'])) {
                                    $query = "DELETE FROM requirement WHERE requirement_id =" . $_GET['requirement_id'];
                                    $result = mysqli_query($conn, $query);
                                    if ($result) {
                                    ?>
                                        <script>
                        ...
                        <div class="card">
                            <div>
                                ...
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <h3 class="bg-light text-center border border-2 text-light" style=" font-family:Segoe Script; color:white;"><b>Requirements</b>
                                        </div>
                                        <div class="col-sm-2">
                                                        ...
                                                        <tbody class="text-center">
                                                            ...
                                                            if ($result) {
                                                                while ($row = mysqli_fetch_assoc($result)) {
                                                                    ...
                                                                    echo "<td><a href = 'requirement.php?requirement_id=$row[requirement_id]&edit=1'   class='btn btn-info btn-xs  '><i class='fas fa-pencil-alt'>
                                                                    </i>Edit</a>  <a href= 'requirement.php?requirement_id=$row[requirement_id]&delete=1 '  class='btn btn-danger btn-xs' >  <i class='fas fa-trash'>
                                                                    </i>Delete</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            }
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="row">
                                                                    ...
                                                                    <input type="text" name="requirement" class="form-control " value="<?= $requirement ?>">


                                                                    <input type="submit" name="<?= $action ?>" value="<?= $btn_value ?>" class="btn btn-success btn-sm" style="margin-top:39px">
