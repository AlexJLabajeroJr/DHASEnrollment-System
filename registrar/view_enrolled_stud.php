...
$stat = "SELECT * from schoolyr WHERE SYID = '$sy_id'";
...
// $queryer = "SELECT * FROM schoolyr WHERE enrollment_status = 2 AND archieve = 0 WHERE SYID = $sy_id ";
// $resulter = mysqli_query($conn, $queryer);
// $statkol = mysqli_fetch_assoc($resulter);





$query12 = "SELECT * FROM schoolyr WHERE enrollment_status = '2' AND archieve = '0' AND SYID = {$statko['SYID']}";
			   ...
			   with font-awesome or any other icon font library -->
				...
				<li class="nav-item ">
					...
					<ul class="nav nav-treeview text-dark">
						<li class="nav-item">
							<a href="summary.php" class="nav-link  bg-light  ">
...
font-family:Segoe UI; font-size:15px; " href='registrar.php'> <i class='fa fa-arrow-left'></i>&nbspBack &nbsp</a>
								</div>
							</div>
						</div>
										...
										<div class="col-md-3">
											...
											<div class="card card-success card-outline">
												<div class="card-body box-profile">
													...
													<div class="text-center border border-1">
														...
														<h3 class="profile-username text-center" style="font-family:Segoe Script;"><?= $row['last_name'] . " " . $row['first_name'] . ", " . $row['suffix_name'] . ", " . $row['middle_name'] . "."  ?></h3>
														...
														<!-- <B class='badge badge-1 bg-teal' style='background-color:#5D9C59  border-radius: 15px 15px 15px 15px;
																		overflow: hidden;
																		border-style:outset;
																	  border-width: 3px;  border-color:	#ffffff;'>&nbsp&nbsp&nbsp&nbspENROLLED&nbsp&nbsp&nbsp&nbsp</B> -->
											...
											<div class="card card-1 border border-1">
												...
												<div class="card-body">
													...
													<div class="col-xs-12 mb-1" style="font-size:15px;">Date Enrolled :<span class="badge badge-xs badge-success"> <?= date('F d, Y', strtotime($statko['DATE_ENROLLED'])) ?></span></div>
													...
													if (isset($row['parent_name']) != ($row['guardian_name'])) {
														echo"<strong><i class='fas fa-user-alt mr-1'></i>Parent Name</strong>";
														echo "<p class='text-muted'> " . $row['parent_name'] . "</p>";
														echo"<hr>";
														echo"<strong><i class='fa fa-tasks' aria-hidden='true'></i>Parent Occupation</strong>";
													
														echo "<p class='text-muted'>&nbsp&nbsp&nbsp&nbsp" . $row['parent_occupation'] . " </p>";
														echo"<hr>";	
														echo"<strong><i class='fas fa-phone-alt mr-1'></i> </i>Parent Contact No</strong>";
														echo "<p class ='text-muted'>&nbsp&nbsp&nbsp&nbsp" . $row['parent_contact_no'] . "</p>";
														echo"<hr>";
													} elseif (isset($row['guardian_name']) != '') {


														echo"<strong><i class='fas fa-user-alt mr-1'></i>Guardian Name</strong>";
														echo "<p class='text-muted'> " . $row['guardian_name'] . "</p>";
														echo"<hr>";
														echo"<strong><i class='fa fa-tasks' aria-hidden='true'></i>Guardian Occupation</strong>";
													
														echo "<p class='text-muted'>&nbsp&nbsp&nbsp&nbsp" . $row['guardian_occupation'] . " </p>";
														echo"<hr>";	
														echo"<strong><i class='fas fa-phone-alt mr-1'></i> </i>Guardian Contact No</strong>";
														echo "<p class ='text-muted'>&nbsp&nbsp&nbsp&nbsp" . $row['guardian_contact_no'] . "</p>";
														echo"<hr>";
											...
											<div class="card">
												<div class="card-header p-2">
													<ul class="nav nav-pills">
														<li class="nav-item"><a class="nav-link active" href="#settings" data-toggle="tab">Requirement Status</a></li>
														<li class="nav-item" ><a class="nav-link  " href="#timeline" data-toggle="tab">Enrollment Status</a></li>

														<li class="nav-item"><a class="nav-link " href="#activity" data-toggle="tab">Payment Status</a></li>
            ...
            <select class="form-control badge badge-xs" onchange="status_updatesu(this.options[this.selectedIndex].value, '<?php echo $row12['SYID']; ?>')">
                ...
                <option value="2">Fully Paid</option>
						...
						<br>
																	...
																	<?php if ($statko['payment_status'] == '1') : ?>
																		<div class="form-group row">
																	...
																	<?php if ($statko['payment_status'] == '2') : ?>
														...
														<div class=" tab-pane" id="timeline">
															...
															<div class="form-group row">
																		<span style="font-size: 36px; color: green; background-color: lightgreen; border: px solid green; padding: 10px; animation: movingText 2s infinite; display: flex; justify-content: center; align-items: center; width: 100%; font-weight: bold;">ENROLLED</span>
																	</div>
															...
															foreach ($incomplete_requirements as $grade_level_id => $requirements) {
																if (is_array($requirements)) {
																	...
																	switch ($grade_level_id) {
																		...
																		case 21:
																		case 22:
																			echo "<span style='background-color: #ffcccc; padding: 10px;' >Incomplete Requirments :  No Moral Certicate || No Form 137 || No Barangay Clearance Certificate</span> <span style='color:red'></span>,<br>";
																			break;
																		case 23:
																		case 24:
																			echo "<span style='background-color: #ffcccc; padding: 10px;' >Incomplete Requirments :  No Moral Certicate || No Form 137 || No Barangay Clearance Certificate || No Permanent Record (SF10)</span> <span style='color:red'></span>,<br>";
																			break;
																		default:
																			break;
																	}
																} else {
																	echo "<span style='background-color: #ccffcc; padding: 10px;' >Complete Requirements&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span> <span style='color:red'></span><br>";
																}
															}
															?>
  <br>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-2 text-center mt-2 border border-top-0 border-left-0 border-right-0" style=";font-size: 14px;">
...
<script type="text/javascript">
    function status_updates(value, SYID) {
        let url = "
https://dv1enrollment-system.online/registrar/view_req.php?SYID=" + SYID + "&requirement_status=" + value;
...
<br>
															...
															$static = "SELECT * from schoolyr WHERE SYID = '$sy_id'";
															$des = mysqli_query($conn, $static);
															...
															$query22 = "SELECT * FROM student WHERE student_id = $row1[student_id] ";
															$result2 = mysqli_query($conn, $query22);
															$love = mysqli_fetch_assoc($result2);
															$sad = $love["student_id"];




															$sqler = "SELECT * FROM student_requirements AS sr
INNER JOIN schoolyr AS sch ON sr.SYID = sch.SYID
INNER JOIN requirement AS r ON sr.requirement_id = r.requirement_id
INNER JOIN student as stud ON stud.student_id = sch.student_id
INNER JOIN grade_level as grad ON grad.GRADE_lEVEL_ID = stud.GRADE_lEVEL_ID
WHERE sch.requirement_status = 2 AND sr.SYID = $sy_id";

															$result = mysqli_query($conn, $sqler);
															$try = mysqli_fetch_assoc($result);



															$sqlero = "SELECT * FROM student_requirements AS sr
INNER JOIN schoolyr AS sch ON sr.SYID = sch.SYID
INNER JOIN requirement AS r ON sr.requirement_id = r.requirement_id
INNER JOIN student as stud ON stud.student_id = sch.student_id
INNER JOIN grade_level as grad ON grad.GRADE_lEVEL_ID = stud.GRADE_lEVEL_ID
WHERE sch.requirement_status = 1 AND sr.SYID = $sy_id";

															$result = mysqli_query($conn, $sqlero);
															$trying = mysqli_fetch_assoc($result);
															...
															<?php if (isset($try)) { ?>
																...
																<form action="control4.php" method="POST" target="_blank">
																	<input type="hidden" name="student_id" value="<?php echo $sad; ?>">
																	<!-- this row will not appear when printing -->
																	<div class="row no-print">
																		<div class="col-xs-12">
																			Notify Student about Requirement their Status :
																			<span class="pull-right">
																				<button style="font: 120%/120% 'Freckle Face', cursive;">
																					<i class="fa-solid fa-envelope"> &nbsp</i>Send Email
																				</button>
																			</span>
																		</div>
																	</div>
															...
															<?php if (isset($trying)) { ?>
																...
																<form action="control3.php" method="POST" target="_blank">
																	<input type="hidden" name="student_id" value="<?php echo $sad; ?>">
																	<!-- this row will not appear when printing -->
																	<div class="row no-print">
																		<div class="col-xs-12">
...
<script type="text/javascript">
    function status_updatesu(value, SYID) {
        let url = "
https://dv1enrollment-system.online/registrar/view_enrolled_stud.php?SYID=" + SYID + "&payment_status=" + value;
        let xhr = new XMLHttpRequest();
        xhr.open("GET", url, true);
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
