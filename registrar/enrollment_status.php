...
font-family:Segoe UI; font-size:15px; " href='view_student_req.php'> <i class='fa fa-arrow-right'></i>&nbspView requirements</a>
                                        </div>
...
<a title="View" href="control1.php?action=view&SYID=' . $row['SYID'] . '" class="btn btn-0 btn-sm border border-1 bg-0 mb-2 text-light" style  = "background-color:#19A7CE; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 4px 20px 0 rgba(0, 0, 0, 0.1); 
border-style:solid;">View Requirements&nbsp<span class="fa fa-folder"></span></a>
...
<a title="View" href="control5.php?action=view&SYID=' . $row['SYID'] . '" class="btn btn-0 btn-sm border border-1 bg-0 mb-2  text-light" style  = "background-color:#188366 ;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 4px 20px 0 rgba(0, 0, 0, 0.1); 
border-style:solid;">View Payment	
...
<!-- 
                                                              ...
                                                              <option value="3">REJECT</option> -->
                                                                ...
                                                                echo '
<td align="center bg-dark">

<div class="btn-group ">
<button type="button" class="btn btn-default btn-flat">Update Status</button>
...
<a title="Set to Enrolled" href="control2.php?action=enroll&student_id=' . $row['student_id'] . '" class="btn btn-light btn-sm border border-1 bg-light mb-2 " style  = " box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 4px 20px 0 rgba(0, 0, 0, 0.1); 
border-style:solid;">Set to Enrolled<span class="fa fa-eye"></span></a>
